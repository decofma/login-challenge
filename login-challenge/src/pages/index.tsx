...
export default function Home() {
  ...
  const steps = [
    ...
    <PasswordStep key={4} userData={userData} setUserData={setUserData} onNext={() => setStep(5)} />,
    <PasswordConfirmationStep key={5} userData={userData} setUserData={setUserData} onNext={() => setStep(6)} />,
